...
@Component({
  selector: 'app-test-graficos',
  templateUrl: './test-graficos.component.html',
  styleUrls: ['./test-graficos.component.css']
})
export class TestGraficosComponent implements OnInit {
